...
This project demonstrates the importance of selecting model metrics aligned with business risks rather than accuracy alone. The final XGBoost model provides reliable and practical fraud detection. 
